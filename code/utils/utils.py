...
def common_argparser():
    ...
    parser.add_argument("--multigpu", action='store_true', help='')

    parser.add_argument("--arch", type=str, default="resent50_ori")
    parser.add_argument("--n_expert", type=int, default=3, help="")
    parser.add_argument("--gamma", type=int, default=8, help="")
    parser.add_argument("--lora_alpha", type=int, default=16, help="")

    parser.add_argument("--fast", action='store_true', help='')
    parser.add_argument("--understanding", action='store_true', help='')
    parser.add_argument("--unpretrained", action='store_true', help='')
    parser.add_argument("--accumulation-steps", type=int, default=1, help="")


    parser.add_argument('--lora_layer', nargs='+', type=int)
    parser.add_argument('--lora_rank', nargs='+', type=int)
