...
class MTLTrainer:
    def __init__(self, args):
        ...
        if 'router' in args.arch:
            ...
            trainable_param_num = count_parameters(self.model, True)
            other_param_num = count_parameters(self.model, False)
            print("Non-trainable parameters(+router):", other_param_num)
            print("Trainable parameters(+router):", trainable_param_num) 
...
# CUDA_VISIBLE_DEVICES=0 python train_shufflenet.py --benchmark radimagenet_resnet18 --balancer ourbase --arch lora_soft_router --train-batch 16 --test-batch 16 --gamma 4 --n_expert 11 
# CUDA_VISIBLE_DEVICES=0 python train_shufflenet.py --benchmark radimagenet_resnet18 --balancer ourbase --arch lora_grad --train-batch 64 --test-batch 64 --gamma 4 --n_expert 11 
